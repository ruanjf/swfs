package com.ruanjf.springMVC.dao.jdbc;
...
/**
 * 继承spring的NamedParameterJdbcDaoSupport
 * 提供对数据库jdbc级别的操作
 * 内部使用spring的NamedParameterJdbcDaoSupport与JdbcTemplate
 * @author ruanjf
 * @since  2012-01-02
 */
public class SimpleJdbcDao extends NamedParameterJdbcDaoSupport {
	...
	public KeyHolder updateNamedParamer(String hql,SqlParameterSource sps){
		...
		this.getNamedParameterJdbcTemplate().update(hql, sps, keyHolder);
		return keyHolder;
	}
...
//	 * @return 获得spring的NamedParameterJdbcDaoSupport使用更多功能
//	 */
